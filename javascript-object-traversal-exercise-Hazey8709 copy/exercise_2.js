...
(() => {
    ...
    let mediaList = api.media;
    //console.log(mediaList);

    //! Movies Only Array
    console.log("1: -- Movies Array --");
    ...
    //! Breaking Bad Object
    console.log("2: -- Breaking Bad Object --");
    console.log(mediaList[11]);
    console.log("-- OR --");

    for (let i = 0; i < mediaList.length; i++) {
        if (mediaList[i].Title === "Breaking Bad") {
            console.log(mediaList[i]);
        }
    }

    //! Breaking Bad Object
    console.log("3: -- Movies Coming Soon! --");
    //console.log(mediaList);

    for (let i = 0; i < mediaList.length; i++) {
        if (mediaList[i].ComingSoon === true) {
            console.log(mediaList[i]);
        }
    }
