...
(() => {
    ...
    //! Array of Abilities
    console.log("1: Array of Abilities");
    console.log(api.abilities);

    //! First item Held
    console.log("2: First item Held");
    console.log(api.held_items[0]);

    //! First item Held
    console.log("3: statement variables");
  ...
  //console.log( Bio );
  //console.log(api.types[0].type.name)
  //console.log(api.stats[0].base_stat)

    console.log(`${Bio.name} is a ${Bio.type} with a weight of ${Bio.weight} and has ${Bio.HP} hp.`)
